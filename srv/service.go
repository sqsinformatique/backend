...
func Start() (err error) {
	...
	ref_type.HandleFunc("/status/{id}", ref_statusGetHandler).Methods("GET")
	...
	router.HandleFunc("/api/incidents/{id}", incidentsDeleteHandler).Methods("DELETE")
	router.HandleFunc("/api/incidents/{id}", incidentsGetHandler).Methods("GET")

	router.HandleFunc("/api/objects/getall", objectsGetAllHandler).Methods("GET")
	router.HandleFunc("/api/objects/getall/{type}", objectsGetAllByTypeHandler).Methods("GET")
	...
	router.HandleFunc("/api/maintenance/{id}", maintenanceDeleteHandler).Methods("DELETE")
	router.HandleFunc("/api/maintenance/{id}", maintenanceGetHandler).Methods("GET")
